...
# Build environment
grub_target_cc='x86_64-unknown-linux-gnu-gcc'
grub_target_cc_version='x86_64-unknown-linux-gnu-gcc (GCC) 10.2.1 20201203'
...
grub_target_cppflags=' -Wall -W  -DGRUB_MACHINE_PCBIOS=1 -DGRUB_MACHINE=I386_PC -m32 -nostdinc -isystem /usr/lib64/gcc/x86_64-unknown-linux-gnu/10.2.1/include -I$(top_srcdir)/include -I$(top_builddir)/include'
grub_target_ccasflags=' -g  -m32 -msoft-float'
grub_target_ldflags=' -m32 -Wl,-melf_i386 -no-pie -Wl,--build-id=none'
grub_cflags='-fno-PIE -mtune=generic -O2 -pipe   -g -fno-stack-protector'
grub_cppflags='    -D_FILE_OFFSET_BITS=64'
grub_ccasflags='-fno-PIE -mtune=generic -O2 -pipe   -g -fno-stack-protector'
grub_ldflags='-no-pie -Wl,--as-needed    '
grub_target_strip='x86_64-unknown-linux-gnu-strip'
grub_target_nm='x86_64-unknown-linux-gnu-nm'
grub_target_ranlib='x86_64-unknown-linux-gnu-ranlib'
grub_target_objconf=''
grub_target_obj2elf=''
